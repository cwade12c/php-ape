...
<ul>
    <li style='float:right'><a class='active' href='../Ape.html'>Back To Landing
            Page</a></li>
...
<div>
    ...
    <br>
    <input type='button' value="Save Grades" id="saveBtn"
           style='float: Center;'>
    <input type='button' onclick="location.href = 'grader1.html';" value="Back"
           style='float: Center;'>
    <br>
</div>
</body>
