...
<fieldset>
    ...
    <form method="post" action="generate_report.php">
        ...
        <select name="exam">
            ...
            try {
                ...
                $sql = $db->prepare(
                    "select exam.id, quarter, date, state, quarter.id as quarter_id, name
								from exam inner join quarter 
								on exam.quarter = quarter.id where 1"
                );
	...
	<?php
		...
		<form action="./admin_create_report.php">
        ...
        <input name="first_name" type="checkbox" value="1" checked> First
        Name<br><br>
        ...
        <input name="score" type="checkbox" value="1" checked> Total
        Score<br><br>
        <input name="category_score" type="checkbox" value="1" checked> Category
        Scores<br>
        <br>
