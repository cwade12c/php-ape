...
<form>
    <fieldset>
        ...
        (Hours)
        <br><br>
        Register Deadline: <input type="number" name="deadline" min="2"
                                  max="24">
        <br>
        (Hours Prior)
        <br><br>
        ...
        Categories:
        <form>
            <input type="checkbox" name="category" value="data_abstraction">
            Data Abstraction<br>
            <input type="checkbox" name="category" value="general"> General<br>
            <input type="checkbox" name="category" value="linked_list"> Linked
            List<br>
